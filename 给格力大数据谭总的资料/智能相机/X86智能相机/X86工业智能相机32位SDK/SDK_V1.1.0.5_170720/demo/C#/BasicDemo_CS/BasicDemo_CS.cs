    ...
    public partial class CBasicDemo_CS : Form
    {
        ...
        private void bnSaveBmp_Click(object sender, EventArgs e)
        {
         ...
         //   UInt32 nDataLen = 0;
            ...
            IntPtr pBcr = Marshal.StringToHGlobalAnsi(stImageOutInfo.chResult);


            CMvSmartSDK.MV_SC_RESULT_BCR stBcrInfo = new CMvSmartSDK.MV_SC_RESULT_BCR();
            stBcrInfo = (CMvSmartSDK.MV_SC_RESULT_BCR)Marshal.PtrToStructure(pBcr, Type(CMvSmartSDK.MV_SC_RESULT_BCR));
