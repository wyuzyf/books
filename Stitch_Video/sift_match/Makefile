...
# Template: app
# Command: c:\qt\4.8.4\bin\qmake.exe -spec ..\..\Qt\4.8.4\mkspecs\win32-g++ CONFIG+=declarative_debug -o Makefile sift_match.pro
#############################################################################
...
Makefile: sift_match.pro  ../../Qt/4.8.4/mkspecs/win32-g++/qmake.conf ../../Qt/4.8.4/mkspecs/features/device_config.prf \
	...
	$(QMAKE) -spec ..\..\Qt\4.8.4\mkspecs\win32-g++ CONFIG+=declarative_debug -o Makefile sift_match.pro
